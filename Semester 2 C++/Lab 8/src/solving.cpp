...
void Rubik::sequence(const std::string &sec, std::vector<uchar> &solution)
{
...
void Rubik::firstStep(std::vector<uchar> &solution)
{
   whiteCross(solution);
   cornersFirstStep(solution);
}
void Rubik::whiteCross(std::vector<uchar> &solution)
{
...
void Rubik::cornersFirstStep(std::vector<uchar> &solution)
{
...
void Rubik::secondStep(std::vector<uchar> &solution)
{
...
void Rubik::thirdStep(std::vector<uchar> &solution)
{
   yellowCross(solution);
   finalCorners(solution);
}
void Rubik::yellowCross(std::vector<uchar> &solution)
{
   bool repeat;
   ...
   else
   {
      ...
      if (yellows == 3)
         std::cout << "This Rubik's cube has no solution, you neew change the orientation of the edge (" << edge[whistleBlower1].up << "," << edge[whistleBlower1].down << ").\n";
      else if (yellows == 1)
         std::cout << "This Rubik's cube has no solution, you neew change the orientation of the edge (" << edge[whistleBlower2].up << "," << edge[whistleBlower2].down << ").\n";
   }
...
void Rubik::finalCorners(std::vector<uchar> &solution)
{
   permutationFinalCorners(solution);
   positionFinalCorners(solution);
}
void Rubik::permutationFinalCorners(std::vector<uchar> &solution)
{
   bool repeat = true;
   while (repeat)
   {
...
void Rubik::positionFinalCorners(std::vector<uchar> &solution)
{
...
// Movements
void Rubik::R(std::vector<uchar> &solution)
{
   Corner aux;
   Edge laux;
...
void Rubik::R2(std::vector<uchar> &solution)
{
   R(solution);
   R(solution);
}
...
void Rubik::L(std::vector<uchar> &solution)
{
   Corner aux;
   Edge laux;
...
void Rubik::L2(std::vector<uchar> &solution)
{
   L(solution);
   L(solution);
}
...
void Rubik::D(std::vector<uchar> &solution)
{
   Corner aux;
   Edge laux;
...
void Rubik::D2(std::vector<uchar> &solution)
{
   D(solution);
   D(solution);
}
...
void Rubik::U(std::vector<uchar> &solution)
{
   Corner aux;
   Edge laux;
...
void Rubik::U2(std::vector<uchar> &solution)
{
   U(solution);
   U(solution);
}
...
void Rubik::F(std::vector<uchar> &solution)
{
   Corner aux;
   Edge laux;
...
void Rubik::F2(std::vector<uchar> &solution)
{
   F(solution);
   F(solution);
}
...
void Rubik::B(std::vector<uchar> &solution)
{
   Corner aux;
   Edge laux;
...
void Rubik::B2(std::vector<uchar> &solution)
{
   B(solution);
   B(solution);
}
...
void Rubik::solve(std::vector<uchar> &solution, const char &method)
{
   solution.clear();
   if (method == 'B')
   {                        // Beginners method
...
void Rubik::readSticker(char &c, const uchar is)
{
   char caracter;
   c = 'f';
   do
   {
      ...
      if ((tolower(caracter) == 'w') || (caracter == '1'))
         ...
         c = 'r';
      else if ((tolower(caracter) == 'b') || (caracter == '5'))
         c = 'l';
      else if ((tolower(caracter) == 'y') || (caracter == '6'))
         c = 'y';
   } while (c == 'f');
}
void Rubik::readRubik(std::array<std::array<uchar, 9>, 6> &is)
{
   readSticker(corner[3].up, is[0][0]);
   readSticker(edge[2].up, is[0][1]);
   readSticker(corner[2].up, is[0][2]);
   readSticker(edge[3].up, is[0][3]);
   readSticker(center[0].center, is[0][4]);
   readSticker(edge[1].up, is[0][5]);
   readSticker(corner[0].up, is[0][6]);
   readSticker(edge[0].up, is[0][7]);
   readSticker(corner[1].up, is[0][8]);

   readSticker(corner[3].right, is[1][0]);
   readSticker(edge[3].down, is[1][1]);
   readSticker(corner[0].left, is[1][2]);
   readSticker(edge[10].down, is[1][3]);
   readSticker(center[4].center, is[1][4]);
   readSticker(edge[11].down, is[1][5]);
   readSticker(corner[7].right, is[1][6]);
   readSticker(edge[7].down, is[1][7]);
   readSticker(corner[4].left, is[1][8]);

   readSticker(corner[0].right, is[2][0]);
   readSticker(edge[0].down, is[2][1]);
   readSticker(corner[1].left, is[2][2]);
   readSticker(edge[11].up, is[2][3]);
   readSticker(center[1].center, is[2][4]);
   readSticker(edge[8].up, is[2][5]);
   readSticker(corner[4].right, is[2][6]);
   readSticker(edge[4].down, is[2][7]);
   readSticker(corner[5].left, is[2][8]);

   readSticker(corner[1].right, is[3][0]);
   readSticker(edge[1].down, is[3][1]);
   readSticker(corner[2].left, is[3][2]);
   readSticker(edge[8].down, is[3][3]);
   readSticker(center[2].center, is[3][4]);
   readSticker(edge[9].down, is[3][5]);
   readSticker(corner[5].right, is[3][6]);
   readSticker(edge[5].down, is[3][7]);
   readSticker(corner[6].left, is[3][8]);

   readSticker(corner[2].right, is[4][0]);
   readSticker(edge[2].down, is[4][1]);
   readSticker(corner[3].left, is[4][2]);
   readSticker(edge[9].up, is[4][3]);
   readSticker(center[3].center, is[4][4]);
   readSticker(edge[10].up, is[4][5]);
   readSticker(corner[6].right, is[4][6]);
   readSticker(edge[6].down, is[4][7]);
   readSticker(corner[7].left, is[4][8]);

   readSticker(corner[4].up, is[5][0]);
   readSticker(edge[4].up, is[5][1]);
   readSticker(corner[5].up, is[5][2]);
   readSticker(edge[7].up, is[5][3]);
   readSticker(center[5].center, is[5][4]);
   readSticker(edge[5].up, is[5][5]);
   readSticker(corner[7].up, is[5][6]);
   readSticker(edge[6].up, is[5][7]);
   readSticker(corner[6].up, is[5][8]);
